  ...
  <div>
    ...
    <div class="gva-table-box">
        <div class="gva-btn-list">
            ...
            <ExportTemplate  template-id="good_Product" />
            <ExportExcel  template-id="good_Product" filterDeleted/>
            <ImportExcel  template-id="good_Product" @on-success="getTableData" />
        </div>
        <el-table
        ref="multipleTable"
        style="width: 100%"
        ...
        <el-table-column type="selection" width="55" />
            ...
            <el-table-column align="left" label="onlineStatus字段" prop="onlineStatus" width="120" />
    ...
    <el-input v-model="formData.status" :clearable="true" placeholder="请输入status字段" />
            ...
            <el-form-item label="onlineStatus字段:" prop="onlineStatus">
    <el-input v-model="formData.onlineStatus" :clearable="true" placeholder="请输入onlineStatus字段" />
</el-form-item>
    ...
    {{ detailFrom.status }}
                    ...
                    <el-descriptions-item label="onlineStatus字段">
    {{ detailFrom.onlineStatus }}
</el-descriptions-item>
