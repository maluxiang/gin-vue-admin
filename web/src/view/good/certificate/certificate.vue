...
<template>
  ...
  <el-input v-model="searchInfo.certificateName" placeholder="搜索条件" />
</el-form-item>
            
            <el-form-item label="certificateStatus字段" prop="certificateStatus">
  <el-input v-model="searchInfo.certificateStatus" placeholder="搜索条件" />
</el-form-item>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column type="selection" width="55" />
            ...
            <el-table-column align="left" label="证书名称" prop="certificateName" width="200" />

            <el-table-column align="left" label="版本号" prop="versionNumber" width="200" />

            <el-table-column align="left" label="证书描述" prop="certificateInfo" width="200" />

            <el-table-column align="left" label="证书类型" prop="certificateStatus" width="200" />
   ...
   <template #default="scope">{{ formatDate(scope.row.createdAt) }}</template>
    ...
    {{ detailFrom.id }}
                    ...
                    <el-descriptions-item label="certificateName字段">
    {{ detailFrom.certificateName }}
</el-descriptions-item>
                    <el-descriptions-item label="versionNumber字段">
    {{ detailFrom.versionNumber }}
</el-descriptions-item>
                    <el-descriptions-item label="certificateInfo字段">
    {{ detailFrom.certificateInfo }}
</el-descriptions-item>
                    <el-descriptions-item label="certificateStatus字段">
    {{ detailFrom.certificateStatus }}
</el-descriptions-item>
