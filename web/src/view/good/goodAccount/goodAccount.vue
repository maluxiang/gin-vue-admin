  ...
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column type="selection" width="55" />
            ...
            <el-table-column label="pictrue字段" prop="pictrue" width="200">
    <template #default="scope">
      <el-image preview-teleported style="width: 100px; height: 100px" :src="getUrl(scope.row.pictrue)" fit="cover"/>
    </template>
</el-table-column>
            <el-table-column align="left" label="设备名称" prop="name" width="220" />

            <el-table-column align="left" label="设备数量" prop="count" width="220" />

            <el-table-column align="left" label="发布状态" prop="status" width="220" >
          <template #default="scope">
            <span class="status-indicator" :class="getStatusClass(scope.row.status)"></span>
            {{ scope.row.status }}
          </template>
          </el-table-column>

            <el-table-column align="left" label="设备类型" prop="equStatus" width="220" />

        <el-table-column align="left" label="操作" fixed="right" :min-width="appStore.operateMinWith">
            <template #default="scope">
            <el-button  type="primary" link class="table-button" @click="getDetails(scope.row)"><el-icon style="margin-right: 5px"><InfoFilled /></el-icon>查看</el-button>
            <el-button  type="primary" link icon="edit" class="table-button" @click="updateGoodAccountFunc(scope.row)">编辑</el-button>
    ...
    {{ detailFrom.id }}
                    ...
                    <el-descriptions-item label="pictrue字段">
    <el-image style="width: 50px; height: 50px" :preview-src-list="returnArrImg(detailFrom.pictrue)" :src="getUrl(detailFrom.pictrue)" fit="cover" />
</el-descriptions-item>
                    <el-descriptions-item label="name字段">
    {{ detailFrom.name }}
</el-descriptions-item>
                    <el-descriptions-item label="count字段">
    {{ detailFrom.count }}
</el-descriptions-item>
                    <el-descriptions-item label="status字段">
    {{ detailFrom.status }}
</el-descriptions-item>
                    <el-descriptions-item label="equStatus字段">
